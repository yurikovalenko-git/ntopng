local lang = {
  ...
  ["about"] = {
    ...
    ["about_x"] = "Про %{product}",
    ["alert_defines"] = "Alerts Definitions",
    ["built_on"] = "Основан на",
  ...
  ["internals"] = {
    ...
    ["periodic_scripts"] = "Periodic Scripts",
  ...
  ["prefs"] = {
    ...
    ["toggle_arp_matrix_generation_description"] = "Toggle the generation of an ARP interactions matrix between hosts. Restart %{product} to make changes effective.",
    ...
    ["toggle_snmp_alerts_port_status_change_description"] = "Toggle alerts generated when an interface status changes",
    ["toggle_snmp_alerts_port_status_change_title"] = "Interface Status Change Alerts",
